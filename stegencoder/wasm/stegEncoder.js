/* @ts-self-types="./stegEncoder.d.ts" */

/**
 * @param {Uint8Array} image
 * @returns {string}
 */
export function decrypt(image) {
    let deferred3_0;
    let deferred3_1;
    try {
 ...
 * @returns {Uint8Array}
 */
export function encrypt(text, image) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('stegEncoder_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
